...
module MergeAccountingClient
  class CompanyInfoApi
    ...
    def company_info_list(opts = {})
      data, _status_code, _headers = company_info_list_with_http_info(opts)
      data
    end
    ...
    def company_info_list_with_http_info(opts = {})
    ...
    # @option opts [Boolean] :include_remote_data Whether to include the original data Merge fetched from the third-party to produce these models.
    # @return [CompanyInfo]
    def company_info_retrieve(id, opts = {})
      data, _status_code, _headers = company_info_retrieve_with_http_info(id, opts)
      data
    end
    ...
    def company_info_retrieve_with_http_info(id, opts = {})
      if @api_client.config.debugging
