...
module MergeAccountingClient
  class PurchaseOrdersApi
    ...
    def purchase_orders_list_with_http_info(x_account_token, opts = {})
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PurchaseOrdersApi#purchase_orders_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def purchase_orders_retrieve_with_http_info(x_account_token, id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PurchaseOrdersApi#purchase_orders_retrieve\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
