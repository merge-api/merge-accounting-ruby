...
module MergeAccountingClient
  ...
  class InvoiceRequest
    ...
    def hash
      [remote_id, type, contact, number, issue_date, due_date, paid_on_date, memo, currency, total_discount, sub_total, total_tax_amount, total_amount, balance, remote_updated_at, payments].hash
    end
