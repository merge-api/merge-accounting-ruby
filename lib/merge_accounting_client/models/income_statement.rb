...
module MergeAccountingClient
  ...
  class IncomeStatement
    ...
    attr_accessor :operating_expenses

    # The revenue minus the operating expenses.
    attr_accessor :net_operating_income

    attr_accessor :non_operating_expenses
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MergeAccountingClient::IncomeStatement` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MergeAccountingClient::IncomeStatement`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cost_of_sales')
        if (value = attributes[:'cost_of_sales']).is_a?(Array)
          self.cost_of_sales = value
        end
      end
      ...
      if attributes.key?(:'operating_expenses')
        if (value = attributes[:'operating_expenses']).is_a?(Array)
          self.operating_expenses = value
        end
      end

      if attributes.key?(:'net_operating_income')
        self.net_operating_income = attributes[:'net_operating_income']
      end

      if attributes.key?(:'non_operating_expenses')
        if (value = attributes[:'non_operating_expenses']).is_a?(Array)
          self.non_operating_expenses = value
        end
      end
