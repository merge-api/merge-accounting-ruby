...
# Unit tests for MergeAccountingClient::LinkedAccountCondition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeAccountingClient::LinkedAccountCondition do
  let(:instance) { MergeAccountingClient::LinkedAccountCondition.new }

  describe 'test an instance of LinkedAccountCondition' do
    it 'should create an instance of LinkedAccountCondition' do
      expect(instance).to be_instance_of(MergeAccountingClient::LinkedAccountCondition)
    end
  end
