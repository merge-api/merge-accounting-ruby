...
# Unit tests for MergeAccountingClient::TrackingCategory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeAccountingClient::TrackingCategory do
  let(:instance) { MergeAccountingClient::TrackingCategory.new }

  describe 'test an instance of TrackingCategory' do
    it 'should create an instance of TrackingCategory' do
      expect(instance).to be_instance_of(MergeAccountingClient::TrackingCategory)
    end
  end
