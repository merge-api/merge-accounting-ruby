...
# Unit tests for MergeAccountingClient::PurchaseOrder
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeAccountingClient::PurchaseOrder do
  let(:instance) { MergeAccountingClient::PurchaseOrder.new }

  describe 'test an instance of PurchaseOrder' do
    it 'should create an instance of PurchaseOrder' do
      expect(instance).to be_instance_of(MergeAccountingClient::PurchaseOrder)
    end
  end
