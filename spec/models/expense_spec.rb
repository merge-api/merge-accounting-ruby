...
# Unit tests for MergeAccountingClient::Expense
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeAccountingClient::Expense do
  let(:instance) { MergeAccountingClient::Expense.new }

  describe 'test an instance of Expense' do
    it 'should create an instance of Expense' do
      expect(instance).to be_instance_of(MergeAccountingClient::Expense)
    end
  end
