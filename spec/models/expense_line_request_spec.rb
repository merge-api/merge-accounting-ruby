...
# Unit tests for MergeAccountingClient::ExpenseLineRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeAccountingClient::ExpenseLineRequest do
  let(:instance) { MergeAccountingClient::ExpenseLineRequest.new }

  describe 'test an instance of ExpenseLineRequest' do
    it 'should create an instance of ExpenseLineRequest' do
