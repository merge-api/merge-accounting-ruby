...
# Unit tests for MergeAccountingClient::ConditionSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeAccountingClient::ConditionSchema do
  let(:instance) { MergeAccountingClient::ConditionSchema.new }

  describe 'test an instance of ConditionSchema' do
    it 'should create an instance of ConditionSchema' do
      expect(instance).to be_instance_of(MergeAccountingClient::ConditionSchema)
    end
  end
