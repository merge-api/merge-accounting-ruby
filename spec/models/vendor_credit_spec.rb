...
# Unit tests for MergeAccountingClient::VendorCredit
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeAccountingClient::VendorCredit do
  let(:instance) { MergeAccountingClient::VendorCredit.new }

  describe 'test an instance of VendorCredit' do
    it 'should create an instance of VendorCredit' do
      expect(instance).to be_instance_of(MergeAccountingClient::VendorCredit)
    end
  end
