...
# Unit tests for MergeAccountingClient::CommonModelScopesDisabledModels
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeAccountingClient::CommonModelScopesDisabledModels do
  let(:instance) { MergeAccountingClient::CommonModelScopesDisabledModels.new }
  ...
  describe 'test an instance of CommonModelScopesDisabledModels' do
    it 'should create an instance of CommonModelScopesDisabledModels' do
      expect(instance).to be_instance_of(MergeAccountingClient::CommonModelScopesDisabledModels)
    end
  end
