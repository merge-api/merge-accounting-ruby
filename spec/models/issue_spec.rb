...
# Unit tests for MergeAccountingClient::Issue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeAccountingClient::Issue do
  let(:instance) { MergeAccountingClient::Issue.new }

  describe 'test an instance of Issue' do
    it 'should create an instance of Issue' do
      expect(instance).to be_instance_of(MergeAccountingClient::Issue)
    end
  end
