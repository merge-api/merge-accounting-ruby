...
# Unit tests for MergeAccountingClient::JournalLineRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeAccountingClient::JournalLineRequest do
  let(:instance) { MergeAccountingClient::JournalLineRequest.new }

  describe 'test an instance of JournalLineRequest' do
    it 'should create an instance of JournalLineRequest' do
