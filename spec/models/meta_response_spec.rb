...
# Unit tests for MergeAccountingClient::MetaResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MergeAccountingClient::MetaResponse do
  let(:instance) { MergeAccountingClient::MetaResponse.new }

  describe 'test an instance of MetaResponse' do
    it 'should create an instance of MetaResponse' do
      expect(instance).to be_instance_of(MergeAccountingClient::MetaResponse)
    end
  end
