...
> <PaginatedAccountingAttachmentList> attachments_list(opts)
...
> <Array(<PaginatedAccountingAttachmentList>, Integer, Hash)> attachments_list_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.attachments_list_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
...
> <AccountingAttachment> attachments_retrieve(id, opts)
...
> <Array(<AccountingAttachment>, Integer, Hash)> attachments_retrieve_with_http_info(id, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.attachments_retrieve_with_http_info(id, opts)
  p status_code # => 2xx
  p headers # => { ... }
