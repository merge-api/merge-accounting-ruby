...
> <PaginatedPurchaseOrderList> purchase_orders_list(opts)
...
begin
  ...
  result = api_instance.purchase_orders_list(opts)
  p result
...
> <Array(<PaginatedPurchaseOrderList>, Integer, Hash)> purchase_orders_list_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.purchase_orders_list_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
...
> <PurchaseOrder> purchase_orders_retrieve(id, opts)
...
begin
  ...
  result = api_instance.purchase_orders_retrieve(id, opts)
  p result
rescue MergeAccountingClient::ApiError => e
...
> <Array(<PurchaseOrder>, Integer, Hash)> purchase_orders_retrieve_with_http_info(id, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.purchase_orders_retrieve_with_http_info(id, opts)
  p status_code # => 2xx
  p headers # => { ... }
